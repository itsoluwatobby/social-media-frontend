...
const UserContextProvider = ({children}) => {
   ...
   const handleFollow = async(userId) => {
    try{
        followed ? await fetchUsers.put(`/${loggedInUserId}/unfollow`, {id: userId}) : await fetchUsers.put(`/${loggedInUserId}/follow`, {id: userId});
        setFollowed(prev => !prev)
        
        const res = await fetchUsers(`/query?userId=${loggedInUserId}`)
   ...
   const value = {
      handleLogout, loggedInUserId, newPosts, setNewPosts, searchResults, setSearchResults, search, setSearch, reveal, setReveal, followed, setFollowed, handleFollow, reload, leftBar, setLeftBar, rightBar, setRightBar, setGetComment, getComment, users, setUsers
   }
